...
# @unpack algo_name, u_mark, X_mark, Z_mark, density_mark, nx, nz, nx_marker, nz_marker, Lz, Lx, nx, nz, nx_marker, nz_marker, X_mark_save, Z_mark_save, vc_t_old, vs_t_old, v_t_old, vc_timestep, vs_timestep, v_timestep, norm_mark, XZ_mark_cell, mark_per_cell, mark_per_cell_array, mark_per_cell_array_el, u0 = advection_algo
# @unpack ϕ_ini = model
...
# ChemicalAdvectionPorosityWave.density_marker_per_cell!(density_mark, X_mark, Z_mark, xs_ad_vec, zs_ad_vec)
# density_mark[100, 50] = 0


# # @time ChemicalAdvectionPorosityWave.add_marker_per_cell!(u_mark, X_mark, Z_mark, density_mark, xs_ad, zs_ad, advection_algo)

# @btime ChemicalAdvectionPorosityWave.add_marker_per_cell!($u_mark, $X_mark, $Z_mark, $density_mark, $xs_ad, $zs_ad, $advection_algo)
# # 83.552 ms (89 allocations: 96.81 MiB)
